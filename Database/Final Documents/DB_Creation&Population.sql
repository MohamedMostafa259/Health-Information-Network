...
(
    ...
    Email VARCHAR(30) NOT NULL,
	PatientID VARCHAR(20) NOT NULL,
    PRIMARY KEY (Relationship, Name, PatientID),
	FOREIGN KEY (PatientID) REFERENCES Patient(PatientID)
...
(
    ...
    NotificationID VARCHAR(20) NOT NULL,
	PatientID VARCHAR(20) NOT NULL,
	PRIMARY KEY (Relationship, Name, PatientID, NotificationID),
    FOREIGN KEY (Relationship, Name, PatientID) REFERENCES Caregiver(Relationship, Name, PatientID),
    FOREIGN KEY (NotificationID) REFERENCES Notification(NotificationID)
);
...
-- Fix for Patient table: A patient can have NULL InsuranceID & PackageID
ALTER TABLE Patient
...
-- Fix for Notification table: allow NULL InsuranceID
...
INSERT INTO Caregiver (PatientID, Relationship, Name, Phone, Email) VALUES
('PAT001', 'Spouse', 'John Thompson', '98765432101', 'john.t@email.com'),
('PAT002', 'Parent', 'Maria Martinez', '87654321012', 'maria.m@email.com'),
('PAT003', 'Sibling', 'Sarah White', '76543210123', 'sarah.w@email.com'),
('PAT004', 'Child', 'Sophie Lee', '65432101234', 'sophie.l@email.com'),
('PAT005', 'Spouse', 'Mark Davis', '54321012345', 'mark.d@email.com');
